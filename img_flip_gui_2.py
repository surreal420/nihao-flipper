...
def drop(event):
    ...
    # Handle potential curly braces in paths on some OS
...
def copy_to_clipboard():
    if hasattr(app, 'combined_image'):
        ...
        data = output.getvalue()[14:]  # Get BMP data, skipping the BMP header
        output.close()
...
app = TkinterDnD.Tk()  # Initialize the app as a TkinterDnD object
app.title("nihao")
...
# Bind drag and drop to the canvas
